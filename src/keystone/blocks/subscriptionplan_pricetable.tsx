...
export const subscriptionplan_pricetable = component({
  label: 'Price Table | Subscription Plans',
  schema: {
    items: fields.array(
      fields.object({
        imageSrc: fields.url({
        ...
        service: fields.relationship({
          ...
          listKey: 'SubscriptionPlan',
          selection: 'id name price billing_interval',
          many: false,
        }),
